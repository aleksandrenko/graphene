...
const initData = {
  nodes: [
    { x: 313, y: 97, color: '#FF4040', id: 'daeb3890', isSelected: true, label: '...' },
    { x: 221, y: 254, color: '#58427C', id: 'c9a88954', isSelected: false, label: '...' },
    { x: 516, y: 234, color: '#006400', id: 'fa70c835', isSelected: false, label: '...' }
  ],
  edges: [
